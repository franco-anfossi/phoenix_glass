...
class NosotrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nosotro" do
    assert_difference("Nosotro.count") do
      post nosotros_url, params: { nosotro: { descripcion: @nosotro.descripcion, titulo: @nosotro.titulo } }
    end
  ...
  test "should update nosotro" do
    patch nosotro_url(@nosotro), params: { nosotro: { descripcion: @nosotro.descripcion, titulo: @nosotro.titulo } }
