...
class IniciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inicio" do
    assert_difference("Inicio.count") do
      post inicios_url, params: { inicio: { descripcion: @inicio.descripcion, titulo: @inicio.titulo } }
    end
  ...
  test "should update inicio" do
    patch inicio_url(@inicio), params: { inicio: { descripcion: @inicio.descripcion, titulo: @inicio.titulo } }
